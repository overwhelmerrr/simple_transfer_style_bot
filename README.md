...
Open in terminal/cl the required directory where the repository will be located 
...
# How to use
First press start. Than you can press Transfer style or enter command /transfer_style. Send content photo and style photo
...
Also bot command /transfer_style has strict rules to end any state. For example if you've send wrong content image you could reset with /transfer_style
